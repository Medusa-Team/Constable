...
{ struct event_handler_s *eh;
    ...
    (void)string_copy(eh[0].op_name, MEDUSA_OPNAME_MAX,
                      "rbac_h_create_role");
    ...
    (void)string_copy(eh[1].op_name, MEDUSA_OPNAME_MAX,
                      "rbac_h_delete_role");
    ...
    (void)string_copy(eh[2].op_name, MEDUSA_OPNAME_MAX,
                      "rbac_h_role_hierarchy");
    ...
    (void)string_copy(eh[3].op_name, MEDUSA_OPNAME_MAX,
                      "rbac_h_user_assign");
    ...
    (void)string_copy(eh[4].op_name, MEDUSA_OPNAME_MAX,
                      "rbac_h_role_assign");
    ...
    (void)string_copy(eh[5].op_name, MEDUSA_OPNAME_MAX,
                      "rbac_h_perm_assign");
